...
export class JobListComponent implements OnInit {
  ...
  /**
   *  Upon loading the component, fetches all accepted job postings from the database.
   */
  ngOnInit() {
    this.loadJobListAll();
  }
  ...
  /**
   *  Cancels filtering by closing the box an deleting previously fetched details.
   */
  cancelFilter() {
    this.toggleFilter();
    this.filterData = [];
